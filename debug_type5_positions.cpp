...
int main() {
    cout << "=== DEBUG Type 5 Field Positions ===" << endl;

    // TEST: Let's put "CRANE VESTA" in CALLSIGN field to see positioning
    string bitstream;
    ...
    // CALLSIGN: Put "CRANE V" (7 chars)
    string callsignTest = "CRANE V";
    cout << "Testing callsign: '" << callsignTest << "'" << endl;
    bitstream += encode6bitString(callsignTest, 7);

    // VESSEL NAME: Put "ESTA" (4 chars)
    string vesselTest = "ESTA";
    cout << "Testing vessel name: '" << vesselTest << "'" << endl;
    bitstream += encode6bitString(vesselTest, 20);
    ...
    cout << "\nPosition analysis:" << endl;
    cout << "Chars 13-19 (should be callsign): " << payload.substr(13, 7) << endl;
    cout << "Chars 27-46 (should be vessel name): " << payload.substr(27, 20) << endl;
