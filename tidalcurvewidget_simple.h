#ifndef TIDALCURVEWIDGET_SIMPLE_H
#define TIDALCURVEWIDGET_SIMPLE_H
...
class TidalCurveWidgetSimple : public QWidget
{
    Q_OBJECT

public:
    explicit TidalCurveWidgetSimple(QWidget *parent = nullptr);
    ~TidalCurveWidgetSimple();
    ...
    void setTimeRange(int hours = 24);
    void refresh();
...
#endif // TIDALCURVEWIDGET_SIMPLE_H